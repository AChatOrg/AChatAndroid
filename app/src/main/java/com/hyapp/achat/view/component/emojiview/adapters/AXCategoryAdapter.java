...
import com.hyapp.achat.view.component.emojiview.view.AXEmojiLayout;
...
public class AXCategoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, final int i) {
        ...
        if (recent && i == 0) {
            Drawable dr0 = AppCompatResources.getDrawable(layout.getContext(), R.drawable.ic_action_clock);
