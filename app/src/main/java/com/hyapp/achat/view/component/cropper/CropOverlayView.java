...
public class CropOverlayView extends View {
  ...
  private com.hyapp.achat.view.component.cropper.CropImageView.Guidelines mGuidelines;

  /** The shape of the cropping area - rectangle/circular. */
  private com.hyapp.achat.view.component.cropper.CropImageView.CropShape mCropShape;
  ...
  public void resetCropOverlayView() {
    if (initializedCropWindow) {
      setCropWindowRect(com.hyapp.achat.view.component.cropper.BitmapUtils.EMPTY_RECT_F);
      initCropWindow();
      invalidate();
    }
  }
  ...
  /** The shape of the cropping area - rectangle/circular. */
  public com.hyapp.achat.view.component.cropper.CropImageView.CropShape getCropShape() {
    return mCropShape;
  }

  /** The shape of the cropping area - rectangle/circular. */
  public void setCropShape(com.hyapp.achat.view.component.cropper.CropImageView.CropShape cropShape) {
    if (mCropShape != cropShape) {
      mCropShape = cropShape;
        if (Build.VERSION.SDK_INT <= 17) {
        if (mCropShape == com.hyapp.achat.view.component.cropper.CropImageView.CropShape.OVAL) {
  ...
  public com.hyapp.achat.view.component.cropper.CropImageView.Guidelines getGuidelines() {
    return mGuidelines;
  }
   ...
   * application.
   */
  public void setGuidelines(com.hyapp.achat.view.component.cropper.CropImageView.Guidelines guidelines) {
  ...
  public void setInitialCropWindowRect(Rect rect) {
    mInitialCropWindowRect.set(rect != null ? rect : com.hyapp.achat.view.component.cropper.BitmapUtils.EMPTY_RECT);
    if (initializedCropWindow) {
      initCropWindow();
      invalidate();
  ...
  private void initCropWindow() {
    ...
    float leftLimit = Math.max(com.hyapp.achat.view.component.cropper.BitmapUtils.getRectLeft(mBoundsPoints), 0);
    float topLimit = Math.max(com.hyapp.achat.view.component.cropper.BitmapUtils.getRectTop(mBoundsPoints), 0);
    float rightLimit = Math.min(com.hyapp.achat.view.component.cropper.BitmapUtils.getRectRight(mBoundsPoints), getWidth());
    float bottomLimit = Math.min(com.hyapp.achat.view.component.cropper.BitmapUtils.getRectBottom(mBoundsPoints), getHeight());
  ...
  protected void onDraw(Canvas canvas) {
    ...
    if (mCropWindowHandler.showGuidelines()) {
      ...
      if (mGuidelines == com.hyapp.achat.view.component.cropper.CropImageView.Guidelines.ON) {
        drawGuidelines(canvas);
      } else if (mGuidelines == com.hyapp.achat.view.component.cropper.CropImageView.Guidelines.ON_TOUCH && mMoveHandler != null) {
  ...
  private void drawBackground(Canvas canvas) {
    ...
    float left = Math.max(com.hyapp.achat.view.component.cropper.BitmapUtils.getRectLeft(mBoundsPoints), 0);
    float top = Math.max(com.hyapp.achat.view.component.cropper.BitmapUtils.getRectTop(mBoundsPoints), 0);
    float right = Math.min(com.hyapp.achat.view.component.cropper.BitmapUtils.getRectRight(mBoundsPoints), getWidth());
    float bottom = Math.min(com.hyapp.achat.view.component.cropper.BitmapUtils.getRectBottom(mBoundsPoints), getHeight());

    if (mCropShape == com.hyapp.achat.view.component.cropper.CropImageView.CropShape.RECTANGLE) {
      ...
      mPath.reset();
        if (Build.VERSION.SDK_INT <= 17 && mCropShape == com.hyapp.achat.view.component.cropper.CropImageView.CropShape.OVAL) {
  ...
  private boolean calculateBounds(RectF rect) {
    ...
    float left = com.hyapp.achat.view.component.cropper.BitmapUtils.getRectLeft(mBoundsPoints);
    float top = com.hyapp.achat.view.component.cropper.BitmapUtils.getRectTop(mBoundsPoints);
    float right = com.hyapp.achat.view.component.cropper.BitmapUtils.getRectRight(mBoundsPoints);
    float bottom = com.hyapp.achat.view.component.cropper.BitmapUtils.getRectBottom(mBoundsPoints);
