...
final class BitmapCroppingWorkerTask
  ...
  private final WeakReference<com.hyapp.achat.view.component.cropper.CropImageView> mCropImageViewReference;
  ...
  private final com.hyapp.achat.view.component.cropper.CropImageView.RequestSizeOptions mReqSizeOptions;
  ...
  BitmapCroppingWorkerTask(
      com.hyapp.achat.view.component.cropper.CropImageView cropImageView,
      Bitmap bitmap,
      float[] cropPoints,
      int degreesRotated,
      ...
      com.hyapp.achat.view.component.cropper.CropImageView.RequestSizeOptions options,
      Uri saveUri,
  ...
  protected Result doInBackground(Void... params) {
    try {
      if (!isCancelled()) {
        ...
        Bitmap bitmap =
            com.hyapp.achat.view.component.cropper.BitmapUtils.resizeBitmap(bitmapSampled.bitmap, mReqWidth, mReqHeight, mReqSizeOptions);

        if (mSaveUri == null) {
          return new Result(bitmap, bitmapSampled.sampleSize);
        } else {
          com.hyapp.achat.view.component.cropper.BitmapUtils.writeBitmapToUri(
