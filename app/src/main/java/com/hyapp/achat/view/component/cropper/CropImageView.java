...
package com.hyapp.achat.view.component.cropper;
...
public class CropImageView extends FrameLayout {
  ...
  public CropImageView(Context context, AttributeSet attrs) {
    ...
    if (intent != null) {
      Bundle bundle = intent.getBundleExtra(com.hyapp.achat.view.component.cropper.CropImage.CROP_IMAGE_EXTRA_BUNDLE);
      if (bundle != null) {
  ...
  public Rect getCropRect() {
    ...
    return com.hyapp.achat.view.component.cropper.BitmapUtils.getRectFromPoints(
        points,
        orgWidth,
        orgHeight,
  ...
  public Bitmap getCroppedImage(int reqWidth, int reqHeight, RequestSizeOptions options) {
    ...
    if (mBitmap != null) {
      ...
      if (mLoadedImageUri != null
        ...
        com.hyapp.achat.view.component.cropper.BitmapUtils.BitmapSampled bitmapSampled =
            com.hyapp.achat.view.component.cropper.BitmapUtils.cropBitmap(
                getContext(),
                mLoadedImageUri,
                getCropPoints(),
                mDegreesRotated,
        ...
        croppedBitmap =
            com.hyapp.achat.view.component.cropper.BitmapUtils.cropBitmapObjectHandleOOM(
                    mBitmap,
                    getCropPoints(),
                    mDegreesRotated,
                    mCropOverlayView.isFixAspectRatio(),
      ...
      croppedBitmap = com.hyapp.achat.view.component.cropper.BitmapUtils.resizeBitmap(croppedBitmap, reqWidth, reqHeight, options);
    }
  ...
  public void setImageBitmap(Bitmap bitmap, ExifInterface exif) {
    ...
    if (bitmap != null && exif != null) {
      com.hyapp.achat.view.component.cropper.BitmapUtils.RotateBitmapResult result = com.hyapp.achat.view.component.cropper.BitmapUtils.rotateBitmapByExif(bitmap, exif);
  ...
  public void rotateImage(int degrees) {
    if (mBitmap != null) {
      ...
      com.hyapp.achat.view.component.cropper.BitmapUtils.RECT.set(mCropOverlayView.getCropWindowRect());
      float halfWidth = (flipAxes ? com.hyapp.achat.view.component.cropper.BitmapUtils.RECT.height() : com.hyapp.achat.view.component.cropper.BitmapUtils.RECT.width()) / 2f;
      float halfHeight = (flipAxes ? com.hyapp.achat.view.component.cropper.BitmapUtils.RECT.width() : com.hyapp.achat.view.component.cropper.BitmapUtils.RECT.height()) / 2f;
      if (flipAxes) {
      ...
      com.hyapp.achat.view.component.cropper.BitmapUtils.POINTS[0] = com.hyapp.achat.view.component.cropper.BitmapUtils.RECT.centerX();
      com.hyapp.achat.view.component.cropper.BitmapUtils.POINTS[1] = com.hyapp.achat.view.component.cropper.BitmapUtils.RECT.centerY();
      com.hyapp.achat.view.component.cropper.BitmapUtils.POINTS[2] = 0;
      com.hyapp.achat.view.component.cropper.BitmapUtils.POINTS[3] = 0;
      com.hyapp.achat.view.component.cropper.BitmapUtils.POINTS[4] = 1;
      com.hyapp.achat.view.component.cropper.BitmapUtils.POINTS[5] = 0;
      mImageInverseMatrix.mapPoints(com.hyapp.achat.view.component.cropper.BitmapUtils.POINTS);
      ...
      mImageMatrix.mapPoints(com.hyapp.achat.view.component.cropper.BitmapUtils.POINTS2, com.hyapp.achat.view.component.cropper.BitmapUtils.POINTS);
      mZoom /=
          Math.sqrt(
              Math.pow(com.hyapp.achat.view.component.cropper.BitmapUtils.POINTS2[4] - com.hyapp.achat.view.component.cropper.BitmapUtils.POINTS2[2], 2)
                  + Math.pow(com.hyapp.achat.view.component.cropper.BitmapUtils.POINTS2[5] - com.hyapp.achat.view.component.cropper.BitmapUtils.POINTS2[3], 2));
      ...
      // width/height
      com.hyapp.achat.view.component.cropper.BitmapUtils.RECT.set(
          com.hyapp.achat.view.component.cropper.BitmapUtils.POINTS2[0] - halfWidth,
          com.hyapp.achat.view.component.cropper.BitmapUtils.POINTS2[1] - halfHeight,
          com.hyapp.achat.view.component.cropper.BitmapUtils.POINTS2[0] + halfWidth,
          com.hyapp.achat.view.component.cropper.BitmapUtils.POINTS2[1] + halfHeight);

      mCropOverlayView.resetCropOverlayView();
      mCropOverlayView.setCropWindowRect(com.hyapp.achat.view.component.cropper.BitmapUtils.RECT);
      applyImageMatrix(getWidth(), getHeight(), true, false);
      handleCropWindowChanged(false, false);
  ...
  public Parcelable onSaveInstanceState() {
    ...
    if (mSaveBitmapToInstanceState && imageUri == null && mImageResource < 1) {
      mSaveInstanceStateBitmapUri =
          imageUri =
              com.hyapp.achat.view.component.cropper.BitmapUtils.writeTempStateStoreBitmap(
                  getContext(), mBitmap, mSaveInstanceStateBitmapUri);
    }
    if (imageUri != null && mBitmap != null) {
      String key = UUID.randomUUID().toString();
      com.hyapp.achat.view.component.cropper.BitmapUtils.mStateBitmap = new Pair<>(key, new WeakReference<>(mBitmap));
    ...
    mImageMatrix.invert(mImageInverseMatrix);
    mImageInverseMatrix.mapRect(com.hyapp.achat.view.component.cropper.BitmapUtils.RECT);

    bundle.putParcelable("CROP_WINDOW_RECT", com.hyapp.achat.view.component.cropper.BitmapUtils.RECT);
    ...
    if (state instanceof Bundle) {
      ...
      if (mBitmapLoadingWorkerTask == null
        ...
        if (uri != null) {
          ...
          if (key != null) {
            Bitmap stateBitmap =
                com.hyapp.achat.view.component.cropper.BitmapUtils.mStateBitmap != null && com.hyapp.achat.view.component.cropper.BitmapUtils.mStateBitmap.first.equals(key)
                    ? com.hyapp.achat.view.component.cropper.BitmapUtils.mStateBitmap.second.get()
                    : null;
            com.hyapp.achat.view.component.cropper.BitmapUtils.mStateBitmap = null;
    ...
    if (mBitmap != null && width > 0 && height > 0) {
      ...
      if (mDegreesRotated > 0) {
        mImageMatrix.postRotate(
            mDegreesRotated,
            com.hyapp.achat.view.component.cropper.BitmapUtils.getRectCenterX(mImagePoints),
            com.hyapp.achat.view.component.cropper.BitmapUtils.getRectCenterY(mImagePoints));
        mapImagePointsByImageMatrix();
      }
      ...
      float scale =
          Math.min(
              width / com.hyapp.achat.view.component.cropper.BitmapUtils.getRectWidth(mImagePoints),
              height / com.hyapp.achat.view.component.cropper.BitmapUtils.getRectHeight(mImagePoints));
      ...
      if (center) {
        ...
        mZoomOffsetX =
            width > com.hyapp.achat.view.component.cropper.BitmapUtils.getRectWidth(mImagePoints)
                ...
                : Math.max(
                        Math.min(
                            width / 2 - cropRect.centerX(), -com.hyapp.achat.view.component.cropper.BitmapUtils.getRectLeft(mImagePoints)),
                        getWidth() - com.hyapp.achat.view.component.cropper.BitmapUtils.getRectRight(mImagePoints))
                    / scaleX;
        mZoomOffsetY =
            height > com.hyapp.achat.view.component.cropper.BitmapUtils.getRectHeight(mImagePoints)
                ? 0
                : Math.max(
                        Math.min(
                            height / 2 - cropRect.centerY(), -com.hyapp.achat.view.component.cropper.BitmapUtils.getRectTop(mImagePoints)),
                        getHeight() - com.hyapp.achat.view.component.cropper.BitmapUtils.getRectBottom(mImagePoints))
                    / scaleY;
      } else {
  ...
  private void updateImageBounds(boolean clear) {
    if (mBitmap != null && !clear) {
      ...
      float scaleFactorWidth =
          100f * mLoadedSampleSize / com.hyapp.achat.view.component.cropper.BitmapUtils.getRectWidth(mScaleImagePoints);
      float scaleFactorHeight =
          100f * mLoadedSampleSize / com.hyapp.achat.view.component.cropper.BitmapUtils.getRectHeight(mScaleImagePoints);
