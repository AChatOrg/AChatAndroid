...
final class BitmapLoadingWorkerTask extends AsyncTask<Void, Void, BitmapLoadingWorkerTask.Result> {
  ...
  public BitmapLoadingWorkerTask(com.hyapp.achat.view.component.cropper.CropImageView cropImageView, Uri uri) {
    mUri = uri;
  ...
  protected Result doInBackground(Void... params) {
    try {
      if (!isCancelled()) {
        ...
        com.hyapp.achat.view.component.cropper.BitmapUtils.BitmapSampled decodeResult =
            com.hyapp.achat.view.component.cropper.BitmapUtils.decodeSampledBitmap(mContext, mUri, mWidth, mHeight);

        if (!isCancelled()) {

          com.hyapp.achat.view.component.cropper.BitmapUtils.RotateBitmapResult rotateResult =
              com.hyapp.achat.view.component.cropper.BitmapUtils.rotateBitmapByExif(decodeResult.bitmap, mContext, mUri);
