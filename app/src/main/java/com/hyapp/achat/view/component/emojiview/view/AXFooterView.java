...
import com.hyapp.achat.view.component.emojiview.adapters.AXFooterIconsAdapter;
...
class AXFooterView extends AXEmojiLayout {
    ...
    private void init() {
        ...
        Drawable back = ContextCompat.getDrawable(getContext(), R.drawable.ic_action_backspace);
